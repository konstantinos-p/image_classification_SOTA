...
model_ResNet = resnet_he.make_model()
...
for t in range(epochs):
    print("Epoch "+ str(t+1) +"\n-----------------------")
    train_with_tensorboard(train_loader_pretrain,model_ResNet,loss_fn,optimizer,writer,t)
    test_with_tensorboard(val_loader_pretrain, model_ResNet,loss_fn,writer,t,len(train_loader_pretrain))
print("Done!")