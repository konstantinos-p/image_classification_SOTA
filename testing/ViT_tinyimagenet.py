...
from models import ViTransformer
# noinspection PyUnresolvedReferences
from scripts import setup_TinyImagenet, generate_dataloader, train_with_tensorboard_patch, test_with_tensorboard_patch
...
model_ResNet = ViTransformer.make_model()
...
for t in range(epochs):
    print("Epoch "+ str(t+1) +"\n-----------------------")
    train_with_tensorboard_patch(train_loader_pretrain,model_ResNet,loss_fn,optimizer,writer,t)
    test_with_tensorboard_patch(val_loader_pretrain, model_ResNet,loss_fn,writer,t,len(train_loader_pretrain))
print("Done!")